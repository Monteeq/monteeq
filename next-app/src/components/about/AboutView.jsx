...
/**
 * Port of frontend/src/pages/About.jsx.
 * Framer Motion throughout — client component; page.js owns generateMetadata.
 */
        ...
        <div className="ld-v4-hero-text">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            <motion.p className="ld-v4-subtitle" variants={fadeInUp}>
              We built Monteeq because we were tired of watching talented editors get exploited. Our
              mission is to give creators the platform they deserve.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="ld-v4-performance" style={{ background: '#000' }}>
        <div className="ld-v4-container">
          ...
          >
            ...
            <h2>
              Breaking the <span className="ld-v4-outline">Trap.</span>
            </h2>
            <p style={{ maxWidth: '800px', margin: '0 auto' }}>
              For years, editors spent hours mastering their craft, only for clients to take all the
              credit and profit. Monteeq was built to hand that power back to you.
            </p>
          </motion.div>
            ...
            {[
              {
                icon: <TrendingUp />,
                title: 'Deep Insights',
                text: 'Track your growth with advanced analytics and engagement metrics. No more guessing.',
              },
              {
                icon: <Zap />,
                title: 'Insane Speed',
                text: 'Global CDN distribution ensures your highest-quality edits render and stream instantly.',
              },
              {
                icon: <Fingerprint />,
                title: 'Pure Independence',
                text: 'Build your personal brand and audience without relying on traditional clients or middlemen.',
              },
            ].map((item, i) => (
        ...
        >
          <motion.div className="ld-v4-split-text" variants={fadeInUp}>
            ...
            <ul className="ld-v4-list">
              <li>
                <Target size={18} /> <strong>No Gatekeepers</strong> — Your reach is earned, not
                bought.
              </li>
              <li>
                <ShieldCheck size={18} /> <strong>Data Ownership</strong> — You own your audience and
                your metrics.
              </li>
              <li>
                <Sparkles size={18} /> <strong>Art-First</strong> — Technology that amplifies art,
                never replaces it.
              </li>
            </ul>
          </motion.div>
          ...
          >
            <div className="ab-visual-placeholder">
              <div className="ld-v4-perf-icon" style={{ transform: 'scale(3)' }}>
                <Target size={48} />
              </div>
            </div>
          </motion.div>
        ...
        <div className="ld-v4-final-content">
          ...
          >
            <h2>
              ...
              <span className="ld-v4-outline">Legacy?</span>
            </h2>
