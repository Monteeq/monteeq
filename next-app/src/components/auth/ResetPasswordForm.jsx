...
import { resetPassword } from '@/lib/clientApi';
import { authErrorMessage } from '@/lib/authHelpers';

/** Port of frontend/src/pages/ResetPassword.jsx */
          ...
          <motion.div variants={itemVariants} className="auth-v4-header">
            ...
            <p>
              {message
                ...
                : 'Update your account with a high-performance password.'}
            </p>
          </motion.div>
          ...
          <AnimatePresence mode="wait">
            {message ? (
              ...
              >
                ...
                <h2 className="auth-v4-outline" style={{ marginTop: '2rem' }}>
                  Restored.
                </h2>
              ...
              >
                <motion.div variants={itemVariants} className="auth-v4-group">
                  <label htmlFor="reset-password">New Secret Key</label>
                ...
                >
                  {isLoading ? (
                    ...
                    <>
                      Restore Access <ArrowRight size={18} />
                    </>
                  )}
                </motion.button>
              </motion.form>
